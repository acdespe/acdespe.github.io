...
BLOG_AUTHOR = "ACDESPE"  # (translatable)
...
BLOG_EMAIL = "social_acdespe@yahoo.fr"
BLOG_DESCRIPTION = "Association Camerounaise pour le Developpement, l'Entraide Sociale et la Protection de l'Environnement"  # (translatable)
